    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <section className="text-center my-12">
          <h1 className="text-4xl md:text-5xl font-bold font-headline mb-4 tracking-wide">
            Choose Your Seat – Secure Your Place
          </h1>
          <p className="text-lg max-w-3xl mx-auto text-muted-foreground">
            Nomination & Registration are FREE. Attendance requires seat/ticket selection. All payments must be completed during registration to receive:
          </p>
